...
<html lang="en">
  <head>
    ...
    <title>Asuma Admin - Registration</title>
            ...
            @csrf
                ...
                <div class="text-center text-white">
                  ...
                  <p class="gap-items-2 mb-20">
                    ...
                    <a class="btn btn-social-icon btn-round btn-outline btn-danger"
                ...
                <div class="text-center">
                  <p class="mt-15 mb-0 text-white">Already have an account? <a href="{{ route('login') }}" class="text-black ml-5">
                      Sign In</a>
                  </p>
                </div>
              </div>
